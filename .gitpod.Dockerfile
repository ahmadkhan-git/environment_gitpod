...
RUN pacman -Syu --noconfirm \
    && pacman -S --noconfirm base-devel git vim sudo curl wget ccache automake lzop bison gperf base-devel zip curl zlib gcc-multilib libxml2 bzip2 squashfs-tools pngcrush schedtool dpkg lz4 make optipng cpio less python nano bc openssh aarch64-linux-gnu-binutils aarch64-linux-gnu-gcc
